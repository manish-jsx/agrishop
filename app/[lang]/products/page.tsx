...
export default async function ProductsPage({
  ...
  const currentUrl = `${baseUrl}/${params.lang}/products`
  const alternateUrl = `${baseUrl}/${alternateLang}/products`

  const seoData = seoDict.products

  // Featured product for structured data
  const featuredProduct = {
    name: dict.productsPage.items.fertilizer1,
    description: "High-quality NPK Complex Fertilizer for all types of crops in Banaras region",
    image: `${baseUrl}/images/products/npk-fertilizer.jpg`,
    price: "₹450",
    url: `${baseUrl}/${params.lang}/products/fertilizers/npk-complex`,
  }
  ...
  return (
    <>
      ...
      <ProductStructuredData {...featuredProduct} />
